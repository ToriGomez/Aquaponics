...
'Aquaponics Project - Team Advisor: Shane Slack, Team Lead: Justine Hoffa
...
Public Class MainDisplayForm
    ...
    Public serialPortBaudRateInteger As Integer = 9600                                      'Global Dimension for the baud rate of the serial comm.
    ...
    Private Sub MainDisplayForm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        SerialPort1.BaudRate = serialPortBaudRateInteger                                    'Baudrate of 9600 bits/sec.
        SerialPort1.DataBits = serialPortDataBitsInteger                                    '8 data bits of the QBoard.
        ...
        SaverRangeButton.Visible = False                                                                                '
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        Dim receivedHeaderInteger As Integer                                                                            '
        Dim sendByte(21) As Byte                                                                                        '



        Timer1.Enabled = False                                                                                          '
        receivedHeaderInteger = receiveByte(0)                                                                          '
        GreenAlert()                                                                                                    '


        Select Case receivedHeaderInteger                                                                               '
            Case = CInt(&H11)                                                                                           '
                GreenAlert()                                                                                            '
            Case = CInt(&H21)                                                                                           '
                YellowAlert()                                                                                           '
    ...
    Private Sub SerialPort1_DataReceived(sender As Object, e As SerialDataReceivedEventArgs) Handles SerialPort1.DataReceived
        SerialPort1.Read(receiveByte, 0, 21)                                                                            '
        CheckForIllegalCrossThreadCalls = False                                                                         '
        CommButton.BackColor = Color.Green                                                                              '
    ...
    Private Sub FoodTimeTextBox_TextChanged(sender As Object, e As EventArgs) Handles FoodTimeTextBox.TextChanged
        Dim foodTimeDate As Date                                                                                        '
        Dim foodTimeString As String                                                                                    '
        fishFoodTimeBoolean = False                                                                                     '
        Try                                                                                                             '
            foodTimeDate = CDate(FoodTimeTextBox.Text)                                                                  '
            foodTimeString = FoodTimeTextBox.Text                                                                       '
            If foodTimeString <> CStr(foodTimeDate.ToString("HH:mm:ss")) Then                                           '
                SaveTimeButton.Visible = False                                                                          '
                FishFoodAlertLabel.Visible = True                                                             '
            Else                                                                                                        '
                FishFoodAlertLabel.Visible = False
                SaveTimeButton.Visible = True                                                                           '
    ...
    Private Sub SaveRangeButton_Click(sender As Object, e As EventArgs) Handles SaverRangeButton.Click
        rangeSaveBoolean = True                                                                                      '
        DisplayRanges()                                                                                                 '
    ...
    Private Sub AnalogRangeComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles AnalogRangeComboBox.SelectedIndexChanged                                                                                             '
        Select Case AnalogRangeComboBox.Text                                                                            '
            Case "Fish Tank Temperature"                                                                                '
                Try
            ...
            Case "Analog Extra 2"                                                                                       '
                AnalogExtra2(YellowHTextBox.Text, YellowLTextBox.Text, RedHTextBox.Text, RedLTextBox.Text)              '
    ...
    Private Sub AnalogRangeComboBox_TextChanged(sender As Object, e As EventArgs) Handles AnalogRangeComboBox.TextChanged
        If AnalogRangeComboBox.Text <> "Fish Tank Temperature" Then                                                     '
    ...
    Sub DefaultRangeComboBox()
        AnalogRangeComboBox.Items.Add("Fish Tank Temperature")                                                          '
        ...
        rangeSaveSingle(0) = 10                                                                                         '
        rangeSaveSingle(1) = -10                                                                                        '
        rangeSaveSingle(2) = 100                                                                                        '
        rangeSaveSingle(3) = -100                                                                                       '



        rangeSaveSingle(4) = 10                                                                                         '
        rangeSaveSingle(5) = -10                                                                                        '
        rangeSaveSingle(6) = 100                                                                                        '
        rangeSaveSingle(7) = -100                                                                                       '



        rangeSaveSingle(8) = 80                                                                                         '
        rangeSaveSingle(9) = 65                                                                                         '
        rangeSaveSingle(10) = 85                                                                                        '
        rangeSaveSingle(11) = 60                                                                                        '



        rangeSaveSingle(12) = 80                                                                                        '
        rangeSaveSingle(13) = 65                                                                                        '
        rangeSaveSingle(14) = 85                                                                                        '
        rangeSaveSingle(15) = 60                                                                                        '



        rangeSaveSingle(16) = 1.8                                                                                       '
        rangeSaveSingle(17) = 1.4                                                                                       '
        rangeSaveSingle(18) = 2                                                                                         '
        rangeSaveSingle(19) = 1.2                                                                                       '



        rangeSaveSingle(20) = 100                                                                                       '
        rangeSaveSingle(21) = 50                                                                                        '
        rangeSaveSingle(22) = 300                                                                                       '
        rangeSaveSingle(23) = 10                                                                                        '



        rangeSaveSingle(24) = 7                                                                                         '
        rangeSaveSingle(25) = 6.8                                                                                       '
        rangeSaveSingle(26) = 7.2                                                                                       '
        rangeSaveSingle(27) = 6.6                                                                                       '



        rangeSaveSingle(28) = 7                                                                                         '
        rangeSaveSingle(29) = 6.8                                                                                       '
        rangeSaveSingle(30) = 7.2                                                                                       '
        rangeSaveSingle(31) = 6.6                                                                                       '
    End Sub
    ...
    Sub RedAlert()
        ...
        ElseIf receiveByte(1) = &H3A Then                                                                               '
            DigitalByte()                                                                                               '



        ElseIf receiveByte(1) = &H3B Then                                                                               '
            DigitalExtraByte()                                                                                          '



        ElseIf receiveByte(1) = &H3C Then                                                                               '
            DigitalWaterLevelByte()                                                                                     '
        End If
    End Sub
    ...
    Sub AnalogExtra1(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        Try                                                                                                             '
            yellowHighSingle = CSng(yellowHTextString)                                                                  '
        Catch ex As Exception                                                                                           '
            yellowHighSingle = 10                                                                                       '
        End Try                                                                                                         '
        Try                                                                                                             '
        ...
        analogRecHInteger = receiveByte(2)                                                                              '
        analogRecLInteger = receiveByte(3)                                                                              '
        ...
        If AnalogEX1Button.BackColor = Color.Green Then                                                                 '
            AnalogEX1Button.Text = "GOOD"                                                                               '
            sendByte(0) = &H11                                                                                          '
            sendByte(1) = &H12                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub AnalogExtra2(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(4)                                                                              '
        analogRecLInteger = receiveByte(5)                                                                              '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If AnalogEX2Button.BackColor = Color.Green Then                                                                 '
            AnalogEX2Button.Text = "GOOD"                                                                               '
            sendByte(0) = &H17                                                                                          '
            sendByte(1) = &H18                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub FishTankTemp(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(6)                                                                              '
        analogRecLInteger = receiveByte(7)                                                                              '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            ' 
        ...
        If FishTempButton.BackColor = Color.Green Then                                                                  '
            FishTempButton.Text = "GOOD"                                                                                '
            sendByte(0) = &H21                                                                                          '
            sendByte(1) = &H22                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub ReservoirTemp(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(8)                                                                              '
        analogRecLInteger = receiveByte(9)                                                                              '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If ResTempButton.BackColor = Color.Green Then                                                                   '
            ResTempButton.Text = "GOOD"                                                                                 '
            sendByte(0) = &H27                                                                                          '
            sendByte(1) = &H28                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub Conductivity(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(10)                                                                             '
        analogRecLInteger = receiveByte(11)                                                                             '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If ConductButton.BackColor = Color.Green Then                                                                   '
            ConductButton.Text = "GOOD"                                                                                 '
            sendByte(0) = &H31                                                                                          '
            sendByte(1) = &H32                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub DisposableSolids(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(12)                                                                             '
        analogRecLInteger = receiveByte(13)                                                                             '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If DisposeButton.BackColor = Color.Green Then                                                                   '
            DisposeButton.Text = "GOOD"                                                                                 '
            sendByte(0) = &H37                                                                                          '
            sendByte(1) = &H38                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub FishTankPH(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecHInteger = receiveByte(14)                                                                             '
        analogRecLInteger = receiveByte(15)                                                                             '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If FishPHButton.BackColor = Color.Green Then                                                                    '
            FishPHButton.Text = "GOOD"                                                                                  '
            sendByte(0) = &H41                                                                                          '
            sendByte(1) = &H42                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub PlantBedPH(ByVal yellowHTextString As String, ByVal yellowLTextString As String, ByVal redHTextString As String, ByVal redLTextString As String)
        ...
        analogRecLInteger = receiveByte(17)                                                                             '
        analogRecHInteger = analogRecHInteger * 4                                                                       '
        analogRecLInteger = analogRecLInteger \ 64                                                                      '
        analogRecInteger = analogRecHInteger + analogRecLInteger                                                        '
        colorStateColor = TestAnalogData(analogRecInteger, yellowHighSingle,                                            '
        ...
        If PlantPHButton.BackColor = Color.Green Then                                                                   '
            PlantPHButton.Text = "GOOD"                                                                                 '
            sendByte(0) = &H47                                                                                          '
            sendByte(1) = &H48                                                                                          '
            PortWrite()                                                                                                 '
    ...
    Sub DigitalByte()
        Dim digByteRecInteger As Integer                                                                                '



        digByteRecInteger = receiveByte(18)                                                                             '
        DigByte0CheckBox.Checked = GetBit(digByteRecInteger, 0)                                                         '
        ...
        If DigByte0CheckBox.Checked Then                                                                                '
            OutsideLightSensorButton.BackColor = Color.Ivory                                                            '
        ...
        If DigByte1CheckBox.Checked Then                                                                                '
            GrowLightSensorButton.BackColor = Color.Ivory                                                               '
        ...
        If DigByte2CheckBox.Checked Then                                                                                '
            MotionButton.BackColor = Color.Green                                                                        '
        ...
        If DigByte3CheckBox.Checked Then                                                                                '
            FlowMeter1Button.BackColor = Color.Green                                                                    '
        ...
        If DigByte4CheckBox.Checked Then                                                                                '
            FlowMeter2Button.BackColor = Color.Green                                                                    '
        ...
        If DigByte5CheckBox.Checked Then                                                                                '
            FlowMeter3Button.BackColor = Color.Green                                                                    '
        ...
        If DigByte6CheckBox.Checked Then                                                                                '
            FlowMeter4Button.BackColor = Color.Green                                                                    '
        ...
        If DigByte7CheckBox.Checked Then                                                                                '
            FlowMeter5Button.BackColor = Color.Green                                                                    '
    ...
    Sub DigitalExtraByte()
        Dim extraByteRecInteger As Integer                                                                              '



        extraByteRecInteger = receiveByte(19)                                                                           '
        ExtraByte0CheckBox.Checked = GetBit(extraByteRecInteger, 0)                                                     '
        ...
        If ExtraByte0CheckBox.Checked Then                                                                              '
            DigitalEX1Button.BackColor = Color.Red                                                                      '
        ...
        If ExtraByte1CheckBox.Checked Then                                                                              '
            DigitalEX2Button.BackColor = Color.Red                                                                      '
        ...
        If ExtraByte2CheckBox.Checked Then                                                                              '
            DigitalEX3Button.BackColor = Color.Red                                                                      '
        ...
        If ExtraByte3CheckBox.Checked Then                                                                              '
            Pump1OutputButton.BackColor = Color.Green                                                                   '
        ...
        If ExtraByte4CheckBox.Checked Then                                                                              '
            Pump2OutputButton.BackColor = Color.Green                                                                   '
        ...
        If ExtraByte5CheckBox.Checked Then                                                                              '
            Pump3OutputButton.BackColor = Color.Green                                                                   '
        ...
        If ExtraByte6CheckBox.Checked Then                                                                              '
            FishHeaterOutputButton.BackColor = Color.Green                                                              '
        ...
        If ExtraByte7CheckBox.Checked Then                                                                              '
            ResHeaterOutputButton.BackColor = Color.Green                                                               '
    ...
    Sub DigitalWaterLevelByte()
        Dim wlByteRecInteger As Integer                                                                                 '



        wlByteRecInteger = receiveByte(20)                                                                              '
        FishWLHCheckBox.Checked = GetBit(wlByteRecInteger, 0)                                                           '
        ...
        If FishWLHCheckBox.Checked Then                                                                                 '
            FishWLHButton.BackColor = Color.Red                                                                         '
        ...
        If FishWLLCheckBox.Checked Then                                                                                 '
            FishWLLButton.BackColor = Color.Red                                                                         '
        ...
        If PlantWLHCheckBox1.Checked Then                                                                               '
            PlantWLHButton1.BackColor = Color.Red                                                                       '
        ...
        If PlantWLHCheckBox2.Checked Then                                                                               '
            PlantWLHButton2.BackColor = Color.Red                                                                       '
        ...
        If ResWLHCheckBox.Checked Then                                                                                  '
            ResWLHButton.BackColor = Color.Red                                                                          '
        ...
        If ResWLLCheckBox.Checked Then                                                                                  '
            ResWLLButton.BackColor = Color.Red                                                                          '
        ...
        If FishFeederCheckBox.Checked Then                                                                              '
            FishFeederOutputButton.BackColor = Color.Green                                                              '
    ...
    Sub TimeOfLights()
        Dim lightTimeDate As New Date(2021, 11, 16, 0, 0, 0)                                                            '



        lightTimeDate = TimeOfDay                                                                                       '
        ...
        Select Case timeOfDayString                                                                                     '
            ...
            Case "21:00:00"                                                                                             '
                ...
                sendByte(1) = &H86                                                                                      '
                PortWrite()                                                                                             '
                lightBoolean(3) = False


            Case Else
                If motionBoolean Then                                                                                   '
                    sendByte(0) = &H97                                                                                  '
                    sendByte(1) = &H98                                                                                  '
                    PortWrite()                                                                                         '
    ...
    Sub TimeofFeed()
        If FishFoodButton.BackColor = Color.Gray Then                                                                   '
            FishFeederMainButton.BackColor = Color.Gray                                                                 '
            FishFeederMainButton.Text = "OFF"                                                                           '
            If fishFoodTimeBoolean = True Then                                                                          '
                Select Case timeOfDayString                                                                             '
                    Case FoodTimeTextBox.Text                                                                           '
                        ...
                        FishFeederMainButton.BackColor = Color.Green                                                    '
                        FishFeederMainButton.Text = "ON"                                                                '
                        Timer3.Enabled = True                                                                           '
                        fishFoodTimeBoolean = False                                                                     '
                End Select
            End If
        ...
        ElseIf FeedAgainCheckBox.Checked = True And fishFoodTimeBoolean = True Then                                     '
            Select Case timeOfDayString                                                                                 '
                Case FoodTimeTextBox.Text                                                                               '
                    sendByte(0) = &HFF                                                                                  '
                    sendByte(1) = &H11                                                                                  '
        ...
        ElseIf FishFoodButton.BackColor = Color.Green And fishFoodTimeBoolean = True Then
            Dim stateSingle As Single                                                                                   'StateSingle is a vbYes or vbNo Dimension.



            stateSingle = MsgBox("ALERT Fish have been fed today! 
                Would you like to feed again?", CType(vbYesNo + vbCritical +
                vbDefaultButton2, MsgBoxStyle), "Exit")                                        'Message box with message and a Yes and No buttons. Writes Select to stateSingle.



            If stateSingle = vbYes Then                                                                                 'If/Then Function tests if Yes was selected.
                FeedAgainCheckBox.Checked = True                                                                        'If selected Yes, feed fish a second time again.
                Select Case timeOfDayString                                                                             '
                    Case FoodTimeTextBox.Text                                                                           '
                        sendByte(0) = &HFF                                                                              '
                        sendByte(1) = &H11                                                                              '
    ...
    Private Sub Timer3_Tick(sender As Object, e As EventArgs) Handles Timer3.Tick
        If FishFeederMainButton.BackColor = Color.Green Then                                                            '
            FishFeederMainButton.BackColor = Color.Gray                                                                 '
            FishFeederMainButton.Text = "OFF"                                                                           '
            Timer3.Enabled = False                                                                                      '
        End If
        If SaveLabel.Visible = True Then                                                                                '
